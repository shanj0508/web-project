...
//获取屏幕div
var divScreen = document.querySelector('#screen'); //获取按钮元素
...
var spanQueue = document.querySelector('#queue'); //初始化号码

var n = 0; //定义数组，存放已经取的号码
...
btnCreateNumber.onclick = function () {
  ...
  queue.push.call(queue, n); // spanQueue.innerText = queue.toString()
...
btnCallNumber.onclick = function () {
  ...
  divScreen.innerText = "\u8BF7".concat(m, "\u53F7\u987E\u5BA2\u5C31\u9910");
  spanQueue.innerText = JSON.stringify(queue);
};
